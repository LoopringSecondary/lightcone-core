...
class TokenReserveManager_ActualAmountSpec extends FlatSpec with Matchers {
  ...
  "simpleTest1" should "calculate actual amount" in {
    ...
    lrcTokenReserveManager.init(1000, 1000)
  ...
  "simpleTest2" should "calculate actual amount" in {
    ...
    xyzTokenReserveManager.init(1000, 10)
    lrcTokenReserveManager.init(1000, 1000)
    gtoTokenReserveManager.init(1000, 1000)
  ...
  "simpleTest4" should "calculate actual amount" in {
    ...
    lrcTokenReserveManager.init(1000, 60)
    xyzTokenReserveManager.init(1000, 1000)
  ...
  "simpleTest6" should "calculate actual amount" in {
    ...
    lrcTokenReserveManager.init(1000, 10)
    xyzTokenReserveManager.init(1000, 1000)
  ...
  "simpleTest8" should "calculate actual amount" in {
    ...
    lrcTokenReserveManager.init(1000, 50)
    xyzTokenReserveManager.init(1000, 1000)
