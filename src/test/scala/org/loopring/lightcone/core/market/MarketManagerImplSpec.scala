...
class MarketManagerImplSpec extends OrderAwareSpec {
  ...
  //   assert(res.rings.size == 1 && res.fullyMatchedOrderIds.size == 2 && res.matchedMakers.size == 2)
  //   assert(res.matchedMakers("taker1").matchable.amountS == 0)
  //   assert(res.matchedMakers("maker1").matchable.amountS == 0)
  ...
  //   res1.matchedMakers("taker1").matchable should be(OrderState())
  //   assert(pendingRingPool.orderMap("taker1").pendingAmountS == 10)
  //   assert(pendingRingPool.orderMap("maker1").pendingAmountS == 100)
  ...
  //   val res = marketManager.submitOrder(taker)
  //   assert(res.rings.size == 2 && res.fullyMatchedOrderIds.size == 3 && res.matchedMakers.size == 3)
  //   assert(res.matchedMakers("taker2").matchable.amountS == 0)
  //   assert(res.matchedMakers("maker2").matchable.amountS == 0)
  //   assert(res.matchedMakers("maker3").matchable.amountS == 0)
  ...
  //   val res = marketManager.submitOrder(taker)
  //   assert(res.rings.size == 2 && res.fullyMatchedOrderIds.size == 2 && res.matchedMakers.size == 3)
  //   assert(res.matchedMakers("taker3").matchable.amountS == 0)
  //   assert(res.matchedMakers("maker4").matchable.amountS == 0)
  //   assert(res.matchedMakers("maker5").matchable.amountS == 100)
  ...
  //   assert(res.rings.isEmpty && res.fullyMatchedOrderIds.size == 1 && res.matchedMakers.size == 1)
  //   assert(res.matchedMakers("maker--6").matchable.amountS == 0)
  ...
  //   assert(res.rings.size == 1 && res.fullyMatchedOrderIds.size == 2 && res.matchedMakers.size == 2)
  //   assert(res.matchedMakers("taker4").matchable.amountS == 0)
  //   assert(res.matchedMakers("maker5").matchable.amountS == 0)
  ...
  //     _actual = Some(OrderState(amountS = 100, amountB = 10, amountFee = 10))
  //   )
  //   val res = marketManager.deleteOrder(order.id)
  //   info(res.toString)
  //   assert(res)
  ...
  //   assert(res.rings.size == size && res.fullyMatchedOrderIds.size == 2 * size && res.matchedMakers.size == 2 * size)
  //   (0 until size) foreach {
  //     i ⇒
  //       assert(res.matchedMakers("taker-" + i).matchable.amountS == 0)
  //       assert(res.matchedMakers("maker-" + i).matchable.amountS == 0)
